...
//RWD選單處理:桌機使用superfish，手機平板使用simplerSidebar，而simplerSidebar內的選單為複製主選單內容。
        ...
        var menucode = "\
<ul>\
<li><a href='oil-firm-base.html' target='_self'>業者基本資料查詢</a></li>\
<li><a href='#' target='_self'>管線與儲槽資料查詢</a>\
<ul><li><a href='oil-pipe-data.html' target='_self'>管線資料查詢</a></li><li><a href='oil-storage-data.html' target='_self'>儲槽資料查詢</a></li></ul>\
</li>\
<li><a href='oil-check.html' target='_self'>查核資訊查詢</a></li>\
<li><a href='oil-test.html' target='_self'>檢測資訊查詢</a></li>\
</ul>\
";
