...
from 天然氣_自評表分類檔 lv1
left join 天然氣_自評表分類檔 lv2 on lv1.天然氣自評表分類guid=lv2.天然氣自評表分類父層guid and lv2.天然氣自評表分類狀態='A'
left join 天然氣_自評表分類檔 lv3 on lv2.天然氣自評表分類guid=lv3.天然氣自評表分類父層guid and lv3.天然氣自評表分類狀態='A'
