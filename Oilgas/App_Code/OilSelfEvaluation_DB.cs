...
select (
select lv1.石油自評表分類guid as lvGuid,lv1.石油自評表分類名稱 as lvName,lv1.石油自評表分類階層 as lv,isnull(lv1.石油自評表分類參考資料,'') as ref
,lv2.石油自評表分類guid as lvGuid,lv2.石油自評表分類名稱 as lvName,lv2.石油自評表分類父層guid as pGuid,lv2.石油自評表分類階層 as lv,isnull(lv2.石油自評表分類參考資料,'') as ref
,lv3.石油自評表分類guid as lvGuid,lv3.石油自評表分類名稱 as lvName,lv3.石油自評表分類父層guid as pGuid,lv3.石油自評表分類階層 as lv,isnull(lv3.石油自評表分類參考資料,'') as ref
