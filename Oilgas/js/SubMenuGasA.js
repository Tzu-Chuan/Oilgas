...
var filecode = '<div class="font-size4 font-normal">';
filecode += '<i class="fa fa-file-word-o IconCc" aria-hidden="true"></i><a href="../doc/附件3、110年天然氣生產進口事業查核填寫內容.docx" target="_blank">查核填寫內容下載</a>';
filecode += '<i class="fa fa-file-powerpoint-o IconCc" aria-hidden="true"></i><a href="../doc/查核配合事項(天然氣).pptx" target="_blank">查核配合事項下載</a>';
filecode += '<i class="fa fa-file-powerpoint-o IconCc" aria-hidden="true"></i><a href="../doc/附件4、110年天然氣生產、進口事業輸儲設備查核簡報大綱.pptx" target="_blank">簡報大綱下載</a>';
filecode += '</div>';
